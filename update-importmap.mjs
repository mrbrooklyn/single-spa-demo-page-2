...
const url = `https://single-spa-demo-test.s3-ap-southeast-1.amazonaws.com/%40thawkin3/single-spa-demo-page-2/${process.env.TRAVIS_COMMIT}/thawkin3-single-spa-demo-page-2.js`;
